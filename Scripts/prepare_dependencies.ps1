# Path to mod-profile dir (Eg., C:\Users\MyUser\AppData\Roaming\r2modmanPlus-local\Valheim\profiles\my-profile)
$profilePath = ""
...
Strip "$profilePath\BepInEx\plugins\VentureValheim-World_Advancement_Progression" "VentureValheim-World_Advancement_Progression" -Publicize
Strip "$profilePath\BepInEx\plugins\ASharpPen-Spawn_That" "ASharpPen-Spawn_That"
