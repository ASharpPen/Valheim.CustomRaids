...
internal static class CharacterGlobalKeyMiner
{
    ...
    private static void PrintCreatureKeys()
    {
        ...
        List<string> creatureKeys = new()
        {
            ...
            $"# The entries listed here were extracted at runtime. It shows the prefab names of creatures that will assign globalkeys and playerkeys when defeated, with the actual key listed next to them.",
