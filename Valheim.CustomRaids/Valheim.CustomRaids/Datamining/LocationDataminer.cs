...
internal static class LocationDataminer
{
    ...
    private static void WriteToList(List<ZoneSystem.ZoneLocation> zoneLocations)
    {
        ...
        // Add header
        stringBuilder.AppendLine($"# This file was auto-generated by Custom Raids {CustomRaidPlugin.Version} at {DateTimeOffset.UtcNow.ToString("u")}, with Valheim '{Version.m_major}.{Version.m_minor}.{Version.m_patch}'.");
